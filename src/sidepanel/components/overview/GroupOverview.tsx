...
const GroupOverview: React.FC<GroupOverviewProps> = ({
  ...
  const handleCustomCleanup = async () => {
    ...
    startProgress(
      'Custom Cleanup',
      `Removing users with status: ${selectedStatuses.join(', ')}...`,
    );
    try {
      ...
      actions: [
        {
          ...
          badge:
            (metrics.statusBreakdown?.DEPROVISIONED ?? 0) > 0
            ...
            <div className="px-6 py-4 space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="DEPROVISIONED">
                    {getUserFriendlyStatus('DEPROVISIONED')} Only
                  </option>
              ...
              <p className="text-sm text-gray-600">
                This will export members from <strong>{groupName}</strong> to a{' '}
          ...
          >
            ...
            <div className="px-6 py-4">
              <p className="text-sm text-gray-600 mb-4">
                Select user statuses to remove from this group:
              </p>
