      ...
      actions: [
        {
          ...
          badge:
            orgStats.activeRules && orgStats.activeRules > 0
              ? `${orgStats.activeRules}`
              : undefined,
    ...
    <div className="space-y-6">
        ...
        <div className="relative px-8 py-10">
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Advanced group and user management for Okta administrators. Navigate to a specific
              group, user, or app page to see contextual insights and actions.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard
          ...
          subtitle={
            orgStats.cacheStatus.groupsCached
              ? formatCacheAge(orgStats.cacheStatus.groupsCacheAge)
              : 'Load in Groups tab'
          }
          color="success"
          icon="users"
        ...
        <StatCard
          ...
          subtitle={
            orgStats.cacheStatus.appsCached
              ? formatCacheAge(orgStats.cacheStatus.appsCacheAge)
              : 'Load in Apps tab'
          }
          color="neutral"
          icon="app"
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed">
                      Visit a group, user, or app page in Okta to see contextual metrics and
                      actions.
                    </p>
                  </div>
                </div>
              ...
              <div className="group p-4 bg-gradient-to-br from-amber-50/50 to-amber-50/30 rounded-lg border border-amber-100/50 hover:border-amber-400/30 transition-all duration-200 hover:shadow-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed">
                      Use specialized tabs for advanced features like security scanning and bulk
                      operations.
                    </p>
                  </div>
                </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
            ...
            <div className="space-y-1 text-sm">
              <a
                href="#"
                className="group flex items-center gap-2 p-3 hover:bg-gradient-to-r hover:from-blue-50/50 hover:to-transparent rounded-lg text-gray-700 hover:text-[#007dc1] transition-all duration-200"
              >
                <svg
                  className="w-4 h-4 text-gray-400 group-hover:text-[#007dc1] transition-colors"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
