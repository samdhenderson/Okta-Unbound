          ...
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-16 animate-in fade-in duration-300">
              <div className="relative">
                ...
                <div
                  className="absolute inset-0 w-16 h-16 border-4 border-transparent border-t-[#3d9dd9] rounded-full animate-spin"
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center animate-in fade-in slide-in-from-bottom-3 duration-500">
              ...
              <p className="text-gray-600 max-w-md">
                Click "Load Rules" to analyze your Okta group rules
              </p>
            </div>
