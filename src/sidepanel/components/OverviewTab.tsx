...
interface OverviewTabProps {
  onTabChange: (
    tab: 'rules' | 'users' | 'security' | 'groups' | 'apps' | 'history',
  ...
  return (
    <div className="tab-content active" style={{ fontFamily: 'var(--font-primary)', padding: 0 }}>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {pageType === 'admin' && (
          <AdminOverview targetTabId={targetTabId} onTabChange={onTabChange} />
        )}
        ...
        {pageType === 'unknown' && (
          <div className="py-12">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Waiting for Context</h3>
              <p className="text-gray-600 max-w-md mx-auto">
                Navigate to a group, user, or app page in Okta to see contextual insights and quick
                actions.
              </p>
