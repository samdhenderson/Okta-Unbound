          ...
          <React.Fragment key={s}>
            <div
              className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-all ${
                step >= s ? 'bg-[#007dc1] text-white' : 'bg-gray-100 text-gray-500'
              }`}
            >
            ...
            {s < 3 && <div className={`w-8 h-0.5 ${step > s ? 'bg-[#007dc1]' : 'bg-gray-200'}`} />}
          </React.Fragment>
        ))}
      </div>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <div className="font-medium text-blue-900 text-sm">
                    How User-to-User Copy Works
                  </div>
                  <div className="text-sm text-blue-700 mt-1">
                    Apps will be copied to the target user while preserving their existing settings.
                    Personal information (email, name, etc.) is never copied.
                  </div>
                </div>
              </div>
            </div>
            ...
            <ul className="space-y-1 text-sm text-gray-600">
              ...
              <li>
                ...
                <span className="font-medium">
                  {sourceUserSearch.selectedItem?.firstName}{' '}
                  {sourceUserSearch.selectedItem?.lastName}
                </span>
              </li>
              <li>
                {conversionMode === 'user-to-group' ? (
                  ...
                  <>
                    To user:{' '}
                    <span className="font-medium">
                      {targetUserSearch.selectedItem?.firstName}{' '}
                      {targetUserSearch.selectedItem?.lastName}
                    </span>
                  </>
                )}
              </li>
