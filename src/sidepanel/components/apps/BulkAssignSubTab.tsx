...
const BulkAssignSubTab: React.FC<BulkAssignSubTabProps> = ({
  ...
  const searchApps = useCallback(
    async (query: string): Promise<AppItem[]> => {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600 mt-1">
          Assign multiple groups to multiple apps in a single operation. Search and select groups
          and apps below.
        </p>
      </div>
            ...
            {assignmentResults.map((result, idx) => (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="text-xs text-gray-500 truncate">→ {result.appName}</div>
