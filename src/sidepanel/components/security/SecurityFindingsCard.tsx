...
const SecurityFindingsCard: React.FC<SecurityFindingsCardProps> = memo(
  ({ finding, onViewDetails }) => {
    ...
    return (
      ...
      >
        <div
          className={`p-4 ${config.bgColor} border-b ${config.borderColor} flex items-center justify-between`}
        >
