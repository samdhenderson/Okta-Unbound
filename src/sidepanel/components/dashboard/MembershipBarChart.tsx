...
const MembershipBarChart: React.FC<MembershipBarChartProps> = ({ membershipSources }) => {
  const direct =
    typeof membershipSources.direct === 'number' && !isNaN(membershipSources.direct)
      ? membershipSources.direct
      : 0;
  const ruleBased =
    typeof membershipSources.ruleBased === 'number' && !isNaN(membershipSources.ruleBased)
      ? membershipSources.ruleBased
      : 0;
