  ...
  return (
    ...
    >
      <g>
        ...
        />
        <text x={cx} y={cy - 8} textAnchor="middle" fill="#111827" fontSize={14} fontWeight="600">
          {nameText}
        </text>
...
const GroupDistributionPieChart: React.FC<GroupDistributionPieChartProps> = ({
  ...
  const data = viewMode === 'status' ? buildStatusData(statusBreakdown) : buildRuleData(members);
      ...
      <div style={{ position: 'relative' }}>
        ...
        <ResponsiveContainer width="100%" height={250}>
          <PieChart>
            ...
            <Legend wrapperStyle={{ fontSize: '11px' }} iconSize={10} iconType="circle" />
          </PieChart>
        </ResponsiveContainer>
      </div>
