...
const badgeVariants = {
  ...
  success:
    'bg-gradient-to-r from-emerald-500/10 to-emerald-600/10 text-emerald-600 border-emerald-200/40',
      ...
      <div className="relative px-6 py-6 flex items-center justify-between gap-4">
        <div className="flex items-center gap-4 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            {subtitle && (
              <p className="mt-1.5 text-sm text-gray-600 font-medium leading-relaxed">{subtitle}</p>
            )}
          </div>
        </div>
