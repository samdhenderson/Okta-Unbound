        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <div
                className="absolute inset-0 w-5 h-5 border-2 border-transparent border-t-[#3d9dd9] rounded-full animate-spin"
          ...
          <div className="flex items-center gap-4 text-xs">
            {progress.apiCalls !== undefined && progress.apiCalls > 0 && (
              <div
                className="flex items-center gap-1.5 px-2.5 py-1 bg-blue-50 border border-blue-200/60 rounded-md"
                title="API requests made"
              >
                <svg
                  width="12"
                  height="12"
            ...
            <div
              className="flex items-center gap-1.5 px-2.5 py-1 bg-gray-50 border border-gray-200/60 rounded-md font-mono"
              title="Elapsed time"
            >
              <svg
                width="12"
            ...
            {remainingTime > 0 && progress.current > 2 && (
              <div
                className="flex items-center gap-1.5 px-2.5 py-1 bg-amber-50 border border-amber-200/60 rounded-md font-mono"
