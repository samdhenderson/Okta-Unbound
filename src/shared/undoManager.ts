...
export async function logBulkActivateRulesAction(rules: BulkRuleInfo[]): Promise<UndoAction> {
...
export async function logBulkDeactivateRulesAction(rules: BulkRuleInfo[]): Promise<UndoAction> {
