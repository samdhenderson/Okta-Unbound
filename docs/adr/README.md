...
| [0010](0010-a-subject-on-a-subjectless-rung.md)                     | A rule or group rung may hold one fetched subject — loaded whole, owned by the rung that asked, answered with its own verdict |
| [0011](0011-user-guide-is-a-chrome-free-page-of-leaf-components.md) | The user guide is a chrome-free page of real leaf components fed static fixtures, not demo tabs against a facade seam         |
