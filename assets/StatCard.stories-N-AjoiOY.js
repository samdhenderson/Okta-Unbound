...
}`,...y.parameters?.docs?.source},description:{story:"The same card with motion suppressed — `countUp` is a no-op and the figure is\ncorrect on the first painted frame. This is what every reduced-motion user sees.",...y.parameters?.docs?.description}}};const O=["Default","StringValue","WithSubtitle","WithIcon","Primary","Success","Warning","ErrorState","Clickable","ClickableHover","ClickableFocus","ClickablePressed","LargeNumber","CountUp","Refreshed","CountUpReducedMotion"];export{r as Clickable,m as ClickableFocus,u as ClickableHover,g as ClickablePressed,h as CountUp,y as CountUpReducedMotion,s as Default,p as ErrorState,v as LargeNumber,i as Primary,b as Refreshed,o as StringValue,l as Success,d as Warning,c as WithIcon,n as WithSubtitle,O as __namedExportsOrder,H as default};
