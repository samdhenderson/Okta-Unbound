import{J as v}from"./JumpBar-iQ5L7rJM.js";import"./iframe-mmN7AxbW.js";import"./preload-helper-PPVm8Dsz.js";import"./JumpResultRow-DbMKZd7j.js";import"./jumpDestinations-db1xhCJ2.js";import"./tabs-2VIodLff.js";const{expect:E,fn:j}=__STORYBOOK_MODULE_TEST__,e=(r={})=>({query:"",setQuery:j(),mode:"idle",results:[],error:null,isIdQuery:!1,resolution:null,submit:j(),clear:j(),...r}),s={kind:"group",id:"00gFAKE0000000000001",name:"Engineering"},f={kind:"rule",id:"0prFAKE0000000000001",name:"Eng — All ICs",secondary:"Active"},y={kind:"user",id:"00uFAKE0000000000001",name:"Ada Lovelace",secondary:"ada@example.com"},b={title:"Home/JumpBar",component:v,parameters:{a11y:{config:{rules:[{id:"heading-order",enabled:!1}]}},docs:{description:{component:`The Home tab's first region: one input that **resolves** an id or **searches** names and emails. The distinction is the whole point — an admin usually already has the id, and a name search cannot match one.
