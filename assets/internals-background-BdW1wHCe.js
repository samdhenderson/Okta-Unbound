import{j as n}from"./iframe-mmN7AxbW.js";import{u as a,M as r,c as o}from"./blocks-6hb-cuWT.js";import"./preload-helper-PPVm8Dsz.js";const d=`# Background service worker
...
Okta Unbound Internals / background/guideOnUpdate / crossesMinorVersion

# Function: crossesMinorVersion()

> **crossesMinorVersion**(\`previousVersion\`, \`currentVersion\`): \`boolean\`

Defined in: [src/background/guideOnUpdate.ts:22](https://github.com/samdhenderson/Okta-Unbound-Dev/blob/main/src/background/guideOnUpdate.ts#L22)

True when an update from \`previousVersion\` to \`currentVersion\` crosses a
\`major.minor\` boundary. A missing or unparseable previous version returns
false, because there is no evidence a chapter changed.
