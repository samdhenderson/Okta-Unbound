import{j as e}from"./iframe-mmN7AxbW.js";import{u as t,M as s}from"./blocks-6hb-cuWT.js";import"./preload-helper-PPVm8Dsz.js";function o(r){const n={code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{title:"Getting Started"}),`
...
`]}),`
`,e.jsxs(n.p,{children:["Beside this site, not inside it, is the ",e.jsx(n.strong,{children:"user guide"}),`: the same page the
extension ships, built from `,e.jsx(n.code,{children:"src/guide"})," by ",e.jsx(n.code,{children:"vite.guide.config.ts"}),` and deployed
from this commit to `,e.jsx("a",{href:"https://samdhenderson.github.io/Okta-Unbound/guide/",target:"_blank",rel:"noopener noreferrer",children:"/guide/"}),`.
...
`,e.jsx(n.code,{children:"npm run storybook"}),` and correct where it is meant to be followed. See
`,e.jsx(n.strong,{children:"Documentation → Guide"}),"."]}),`
...
(see `,e.jsx(n.strong,{children:"Documentation → Component Explorer"}),")."]})]})}function h(r={}){const{wrapper:n}={...t(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(o,{...r})}):o(r)}export{h as default};
