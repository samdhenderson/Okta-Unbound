import{B as l}from"./BlastRadiusCascade-DxSEtu1V.js";import"./iframe-mmN7AxbW.js";import"./preload-helper-PPVm8Dsz.js";const{expect:t,within:p}=__STORYBOOK_MODULE_TEST__,n=a=>({direction:"toward-match",matchedBy:"name",targetGroupNames:["Finance"],...a}),h={title:"Users/BlastRadiusCascade",component:l,tags:["autodocs"],parameters:{layout:"padded",docs:{description:{component:`**Every line is structure, not a prediction.** This rule reads this group; it named it this way; it assigns these groups. Nothing here claims the rule will fire, and the footer names that absence once rather than hedging every line.
