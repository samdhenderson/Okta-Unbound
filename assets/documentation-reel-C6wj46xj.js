import{j as e}from"./iframe-mmN7AxbW.js";import{u as s,M as o,c as r}from"./blocks-6hb-cuWT.js";import"./preload-helper-PPVm8Dsz.js";const i=`# The demo reel
...
did is invisible to every control here. Watch the cut end to end before calling it
done; the guards catch what a person watching would miss, not the reverse.
...
so a disabled button will otherwise report a landed click. \`{ optional: true }\`
...
`,e.jsx(o,{title:"Documentation/Reel"}),`
`,e.jsx(r,{children:i})]})}function l(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(a,{...t})}):a()}export{l as default};
