...
}`,...v.parameters?.docs?.source},description:{story:"Withheld: the rule that would place them names them in its exclusion list.",...v.parameters?.docs?.description}}};B.parameters={...B.parameters,docs:{...B.parameters?.docs,source:{originalSource:`{
  parameters: {
    viewport: {
...
}`,...B.parameters?.docs?.source},description:{story:"The 360px floor: a long group name wraps rather than truncating.",...B.parameters?.docs?.description}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    effect: effect({
      groupId: '00gFAKE00000000000011',
      groupName: 'New Hires',
...
story supplies the state itself.`,...o.parameters?.docs?.description}}};w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  args: {
    ...WithCascade.args,
    expanded: true
  },
...
}`,...w.parameters?.docs?.source},description:{story:"The same row already open — the false→true pair `WithCascade` starts.",...w.parameters?.docs?.description}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  args: {
    effect: effect({
...
}`,...f.parameters?.docs?.source},description:{story:'Nothing reads this group, so there is no trigger at all — not a disabled one, and no "no rules" sentence.',...f.parameters?.docs?.description}}};const _=["AddedEffect","RemovedEffect","SeveralRules","NotPredictedAnotherRuleMatches","NotPredictedDirectMembership","NotPredictedAttributionHedged","NotPredictedRuleUnevaluable","NotPredictedRuleInactive","NotPredictedAppMastered","NotPredictedRuleExcludesUser","Compact","WithCascade","CascadeOpen","NoCascade"];export{i as AddedEffect,w as CascadeOpen,B as Compact,f as NoCascade,l as NotPredictedAnotherRuleMatches,y as NotPredictedAppMastered,m as NotPredictedAttributionHedged,p as NotPredictedDirectMembership,v as NotPredictedRuleExcludesUser,h as NotPredictedRuleInactive,g as NotPredictedRuleUnevaluable,d as RemovedEffect,u as SeveralRules,o as WithCascade,_ as __namedExportsOrder,P as default};
