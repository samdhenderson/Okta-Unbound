...
}`,...p.parameters?.docs?.source},description:{story:"Ticking a result adds that user to the basket, and the readout appears.",...p.parameters?.docs?.description}}};const I=["Default","Searching","WithResults","WithError","UserSelected","Compact360","SelectionCarriedAcrossSearches","NoMatchesWithACohortHeld","TickingAResult"];export{h as Compact360,n as Default,u as NoMatchesWithACohortHeld,c as Searching,d as SelectionCarriedAcrossSearches,p as TickingAResult,l as UserSelected,i as WithError,o as WithResults,I as __namedExportsOrder,W as default};
