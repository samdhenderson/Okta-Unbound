import{j as n}from"./iframe-mmN7AxbW.js";import{u as r,M as a,c as o}from"./blocks-6hb-cuWT.js";import"./preload-helper-PPVm8Dsz.js";const i=`# Storage & cache
...
Okta Unbound Internals / shared/storage/welcomeStore / markWelcomeSeen

# Function: markWelcomeSeen()

> **markWelcomeSeen**(): \`Promise\`\\<\`void\`\\>

Defined in: [src/shared/storage/welcomeStore.ts:29](https://github.com/samdhenderson/Okta-Unbound-Dev/blob/main/src/shared/storage/welcomeStore.ts#L29)

Record that the reader dismissed the welcome.
...
Okta Unbound Internals / shared/storage/welcomeStore / readWelcomeSeen

# Function: readWelcomeSeen()

> **readWelcomeSeen**(): \`Promise\`\\<\`boolean\`\\>

Defined in: [src/shared/storage/welcomeStore.ts:18](https://github.com/samdhenderson/Okta-Unbound-Dev/blob/main/src/shared/storage/welcomeStore.ts#L18)

Whether the welcome has been dismissed. A read failure counts as not seen.
...
Okta Unbound Internals / shared/storage/welcomeStore / resetWelcomeSeen

# Function: resetWelcomeSeen()

> **resetWelcomeSeen**(): \`Promise\`\\<\`void\`\\>

Defined in: [src/shared/storage/welcomeStore.ts:38](https://github.com/samdhenderson/Okta-Unbound-Dev/blob/main/src/shared/storage/welcomeStore.ts#L38)

Forget the dismissal, so the welcome shows on the panel's next mount.
...
Okta Unbound Internals / shared/storage/welcomeStore / WELCOME\\_SEEN\\_STORAGE\\_KEY

# Variable: WELCOME\\_SEEN\\_STORAGE\\_KEY

> \`const\` **WELCOME\\_SEEN\\_STORAGE\\_KEY**: \`"okta_unbound_welcome_seen"\` = \`'okta_unbound_welcome_seen'\`

Defined in: [src/shared/storage/welcomeStore.ts:15](https://github.com/samdhenderson/Okta-Unbound-Dev/blob/main/src/shared/storage/welcomeStore.ts#L15)

\`chrome.storage.local\` key holding the dismissed flag.
