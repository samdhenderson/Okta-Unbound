import{j as n}from"./iframe-mmN7AxbW.js";const t=({value:e})=>n.jsx("span",{"aria-hidden":e===null?"true":void 0,className:"flex shrink-0 items-center self-stretch",children:n.jsx("span",{className:`min-w-[2.6ch] text-right text-3xl leading-none tabular-nums ${e===null?"font-normal text-neutral-400":"font-semibold text-neutral-900"}`,children:e===null?"—":e.toLocaleString()})});try{t.displayName="FigureNumber",t.__docgenInfo={description:`A row's leading number.
