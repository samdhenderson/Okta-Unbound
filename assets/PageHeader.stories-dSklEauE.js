...
}`,...v.parameters?.docs?.source},description:{story:"Two statuses on one entity at the narrowest width, both demoted to facts so the title keeps its width.",...v.parameters?.docs?.description}}};w.parameters={...w.parameters,docs:{...w.parameters?.docs,source:{originalSource:`{
  args: {
    title: 'Groups',
    subtitle: 'Browse, search, and manage groups',
    badge: {
...
}`,...w.parameters?.docs?.source},description:{story:"A list rung passes no identity, so the region is absent entirely.",...w.parameters?.docs?.description}}};B.parameters={...B.parameters,docs:{...B.parameters?.docs,source:{originalSource:`{
  args: {
    title: 'Engineering',
...
}`,...B.parameters?.docs?.source},description:{story:"A custom leading node replaces the default back button.",...B.parameters?.docs?.description}}};const L=["Default","WithSubtitle","WithBadgePrimary","WithBadgeSuccess","WithBadgeWarning","WithBadgeDanger","WithActions","Full","WithBackButton","WithBreadcrumbs","WithIdentity","WithCornerAction","WithCornerActionPinned","CornerActionWithoutIdentity","WithIdentityNarrow","WithIdentityUser","WithIdentityUserLockedOut","WithMultipleStatusFactsNarrow","WithoutIdentity","WithCustomLeading"];export{b as CornerActionWithoutIdentity,s as Default,p as Full,l as WithActions,u as WithBackButton,d as WithBadgeDanger,i as WithBadgePrimary,o as WithBadgeSuccess,c as WithBadgeWarning,g as WithBreadcrumbs,m as WithCornerAction,y as WithCornerActionPinned,B as WithCustomLeading,a as WithIdentity,h as WithIdentityNarrow,k as WithIdentityUser,x as WithIdentityUserLockedOut,v as WithMultipleStatusFactsNarrow,n as WithSubtitle,w as WithoutIdentity,L as __namedExportsOrder,C as default};
