import{j as y}from"./iframe-mmN7AxbW.js";import T from"./SelectionTab-DjtoQnKl.js";import{s as a}from"./selectionStore-CrmbAKHN.js";import{O as w}from"./OrgEntityIndexContext-DK-zeuDH.js";import"./preload-helper-PPVm8Dsz.js";import"./useSelection-BI2UGOh3.js";import"./collectionStore-BFbuKXm7.js";import"./useOktaApi.mock-B7ApM7uM.js";import"./registry-l4mQzsmW.js";import"./userDisplay-xpx41Abi.js";import"./groupRuleIndex-CUdSMoPG.js";import"./fetchGroupRulesRequest-DgNCr2VU.js";import"./ruleUtils-Vt2BA8lQ.js";import"./oktaPagination-DzUnd2oi.js";import"./okta-C-BsJJoX.js";import"./types-D54cNL3h.js";import"./orgSnapshotStore-CqR6Bu-g.js";import"./index-Dob3nYDb.js";import"./types-aoYpQiYS.js";import"./ruleOrphans-w7zgihHR.js";import"./memberRuleAttribution-DwskNnmH.js";import"./profile-Bul2VYbY.js";import"./undoManager-Db5dJWVO.js";import"./ruleExpression-YtJDU2CF.js";import"./profileDraft-qVcYAhdY.js";import"./membershipAnalysis-BZfvnwXl.js";import"./groupContext-D0LcfWax.js";import"./membershipVerdict-DUrEZuW9.js";import"./sourceLine-6HOHdWfm.js";import"./profileAttributes-D7zGcuAf.js";import"./dateFormat-C9yVDsck.js";import"./profileFields-BZvCtc6D.js";import"./memberAnalytics-_apwJWix.js";import"./entityCache-CUqsH66e.js";import"./keys-CUIcVywe.js";import"./types-CedNKx8Z.js";import"./SelectionActionBar-CkSq2quh.js";import"./SaveCollectionModal-CsiRSkj9.js";import"./SelectionPane-DSEGeQnu.js";import"./ActionsPane-W4XO7aBW.js";import"./VerbList-DOZ6GAGz.js";import"./ReportsPane-D6W6EJil.js";import"./CollectionsPane-CxTYcvrs.js";import"./CollectionsSection-DppndrV2.js";import"./usePoliciesData-oY6cZYph.js";import"./VerbRunner-CK-T3KUd.js";import"./AttributeSpreadBar-QNQoFo_X.js";import"./chartPalette-Byit8206.js";import"./BreakdownReport-8ktuwLFZ.js";import"./csvUtils-DgNWYp8m.js";import"./useVerbRun-BFNt5FEp.js";import"./useOrgSnapshot-BR7he6Mh.js";const{expect:t,userEvent:s,within:o}=__STORYBOOK_MODULE_TEST__,Te={title:"Selection/SelectionTab",component:T,tags:["autodocs"],parameters:{layout:"fullscreen",a11y:{config:{rules:[{id:"heading-order",enabled:!1}]}},docs:{description:{component:"Reviews and spends the entity-selection basket (`docs/adr/0005-session-chrome.md`). The body is a `Tabs` shell over four panes — **Selection** (the roster), **Actions** (the verbs that spend a cohort), **Reports** (the read-only questions) and **Collections** (the saved cohorts) — following `GroupDetailView`’s five-pane precedent.\n\nA pane with nothing in it **stays**, stating why in a sentence: a strip that grew a seat as each verb landed, or lost one as a partition emptied, would be chrome reshuffling under the reader. Inside a pane the opposite rule still holds — an empty kind is absent rather than stated as a zero.\n\nThe tab strip is not a band; it scrolls with the body, so the rung’s sticky bands are still the header and `SelectionActionBar`, which carries the whole-basket `Save as collection` and, behind **More** with a confirm, `Clear all`. Its sub-row search filters the roster and the saved collections alike."}}},decorators:[n=>y.jsx(w,{oktaOrigin:null,targetTabId:null,enabled:!1,children:y.jsx(n,{})})],beforeEach:()=>(a.clearAll(),()=>a.clearAll())},c={play:async({canvasElement:n})=>{const e=o(n);await t(e.getByText("Nothing selected")).toBeInTheDocument(),await t(e.queryByRole("button",{name:"More"})).not.toBeInTheDocument()}},i={beforeEach:()=>(a.toggle({kind:"user",id:"00uFAKE0001",name:"Dana Example"}),a.toggle({kind:"user",id:"00uFAKE0002",name:"Rowan Example"}),()=>a.clearAll()),play:async({canvasElement:n})=>{const e=o(n);await t(e.getByText("2 users selected")).toBeInTheDocument(),await t(e.getByText("Dana Example")).toBeInTheDocument(),await t(e.getByText("Rowan Example")).toBeInTheDocument(),await t(e.queryByText("Nothing selected")).not.toBeInTheDocument()}},l={beforeEach:()=>(a.toggle({kind:"user",id:"00uFAKE0001",name:"Dana Example"}),a.toggle({kind:"group",id:"00gFAKE0001",name:"Payments Team"}),a.toggle({kind:"rule",id:"00rFAKE0001",name:"Contractors"}),a.toggle({kind:"policy",id:"00pFAKE0001",name:"MFA Enrollment"}),()=>a.clearAll()),play:async({canvasElement:n})=>{const e=o(n);await t(e.getByText("1 user selected")).toBeInTheDocument(),await t(e.getByText("1 group selected")).toBeInTheDocument(),await t(e.getByText("1 rule selected")).toBeInTheDocument(),await t(e.getByText("1 policy selected")).toBeInTheDocument()}},m={beforeEach:()=>{for(let n=0;n<40;n+=1)a.toggle({kind:"user",id:`00uFAKE${String(n).padStart(4,"0")}`,name:`User ${n}`});return()=>a.clearAll()},play:async({canvasElement:n})=>{const e=o(n);await t(e.getByText("40 users selected")).toBeInTheDocument(),await s.click(e.getByRole("button",{name:"Remove User 0 from the selection"})),await t(e.getByText("39 users selected")).toBeInTheDocument(),await t(e.queryByText("User 0")).not.toBeInTheDocument(),await t(e.getByText("User 1")).toBeInTheDocument()}},p={beforeEach:()=>(a.toggle({kind:"user",id:"00uFAKE0001",name:"Dana Example"}),a.toggle({kind:"group",id:"00gFAKE0001",name:"Payments Team"}),()=>a.clearAll()),play:async({canvasElement:n})=>{const e=o(n);await s.click(e.getByRole("button",{name:"Clear users"})),await t(e.getByText("1 user selected")).toBeInTheDocument();const r=o(e.getByRole("dialog",{name:"Clear selected user?"}));await t(r.getByText("Clear 1 selected user? This cannot be undone.")).toBeInTheDocument(),await s.click(r.getByRole("button",{name:"Cancel"})),await t(e.queryByRole("dialog")).not.toBeInTheDocument(),await t(e.getByText("1 user selected")).toBeInTheDocument(),await s.click(e.getByRole("button",{name:"Clear users"})),await s.click(e.getByRole("button",{name:"Clear"})),await t(e.queryByText(/users? selected/)).not.toBeInTheDocument(),await t(e.getByText("1 group selected")).toBeInTheDocument()}},u={beforeEach:()=>(a.toggle({kind:"user",id:"00uFAKE0001",name:"Dana Example"}),a.toggle({kind:"user",id:"00uFAKE0002",name:"Rowan Example"}),a.toggle({kind:"user",id:"00uFAKE0003",name:"Marlow Example"}),()=>a.clearAll()),play:async({canvasElement:n})=>{const e=o(n);await t(e.getByText("3 users selected")).toBeInTheDocument(),await s.type(e.getByRole("searchbox",{name:"Search the selection and saved collections"}),"dana"),await t(e.getByText("3 users selected")).toBeInTheDocument(),await t(e.getByText("Showing 1 of 3.")).toBeInTheDocument(),await t(e.getByText("Dana Example")).toBeInTheDocument(),await t(e.queryByText("Rowan Example")).not.toBeInTheDocument()}},d={beforeEach:()=>(a.toggle({kind:"group",id:"00gFAKE0001",name:"Payments Team"}),()=>a.clearAll()),play:async({canvasElement:n})=>{const e=o(n);await s.type(e.getByRole("searchbox",{name:"Search the selection and saved collections"}),"zzz"),await t(e.getByText("1 group selected")).toBeInTheDocument(),await t(e.getByText('No groups match "zzz".')).toBeInTheDocument()}},g={beforeEach:()=>(a.toggle({kind:"user",id:"00uFAKE0001",name:"Dana Example"}),a.toggle({kind:"group",id:"00gFAKE0001",name:"Payments Team"}),()=>a.clearAll()),play:async({canvasElement:n})=>{const e=o(n),r=o(e.getByRole("tablist",{name:"Selection sections"}));for(const B of["Selection","Actions","Reports","Collections"])await t(r.getByRole("tab",{name:new RegExp(`^${B}`)})).toBeInTheDocument();await t(e.getByText("1 user selected")).toBeInTheDocument(),await s.click(r.getByRole("tab",{name:/^Actions/})),await t(e.getByRole("tabpanel",{name:"Actions"})).toBeInTheDocument(),await t(e.queryByText("1 user selected")).not.toBeInTheDocument(),await s.click(r.getByRole("tab",{name:/^Reports/})),await t(e.getByRole("tabpanel",{name:"Reports"})).toBeInTheDocument(),await s.click(r.getByRole("tab",{name:/^Collections/})),await t(e.getByRole("tabpanel",{name:"Collections"})).toBeInTheDocument(),await t(e.getByText("No saved collections")).toBeInTheDocument(),await s.click(r.getByRole("tab",{name:/^Selection/})),await t(e.getByText("1 user selected")).toBeInTheDocument(),await t(e.getByText("1 group selected")).toBeInTheDocument()}},h={play:async({canvasElement:n})=>{const e=o(n),r=o(e.getByRole("tablist",{name:"Selection sections"}));await t(r.getAllByRole("tab")).toHaveLength(4),await t(e.getByText("Nothing selected")).toBeInTheDocument()}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
...
}`,...c.parameters?.docs?.source},description:{story:"Nothing ticked anywhere in the panel — the empty state names how selection works.",...c.parameters?.docs?.description}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  beforeEach: () => {
...
selection works; nothing claims a count it does not have.`,...h.parameters?.docs?.description}}};const we=["EmptyBasket","OneKind","MixedKinds","LargePartition","ConfirmClearPartition","FilterKeepsTheCountHonest","FilterMatchingNothingSaysSo","PaneStrip","EmptyBasketKeepsThePanes"];export{p as ConfirmClearPartition,c as EmptyBasket,h as EmptyBasketKeepsThePanes,u as FilterKeepsTheCountHonest,d as FilterMatchingNothingSaysSo,m as LargePartition,l as MixedKinds,i as OneKind,g as PaneStrip,we as __namedExportsOrder,Te as default};
