import{r as D,j as E,i as A}from"./iframe-mmN7AxbW.js";import{C as S}from"./ContextBar-luMlvxOe.js";import{s as r}from"./selectionStore-CrmbAKHN.js";import"./preload-helper-PPVm8Dsz.js";import"./useSelection-BI2UGOh3.js";import"./jumpDestinations-db1xhCJ2.js";import"./tabs-2VIodLff.js";const{expect:n,fn:o,userEvent:R,within:s}=__STORYBOOK_MODULE_TEST__,K={title:"Sidepanel/ContextBar",component:S,tags:["autodocs"],parameters:{layout:"fullscreen",docs:{description:{component:`One line of top chrome: a hue-coded connection wire along the panel's top edge, the live Okta tab's entity name, and the session-chrome controls (the Selection count, then Refresh). The wire costs no layout height at rest and thickens into a labelled strip with a real Reconnect control when the connection is down.
